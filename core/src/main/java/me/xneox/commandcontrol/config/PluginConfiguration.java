...
public class PluginConfiguration {
  ...
  @Comment(
      "This module is the opposite of the allowed-commands module and will block players from using specified commands.")
  private final BlockedCommands blockedCommands = new BlockedCommands();

  @Comment(
      "This module will block commands which contain the ':' symbol (example: /bukkit:plugins)")
  private final NamespacedCommands namespacedCommands = new NamespacedCommands();

  @Comment(
      "This module will replace the default command completions with your own list.\n"
          + ""
          + "(!) Currently not working on the Velocity proxy.")
  private final CustomTabComplete customTabComplete = new CustomTabComplete();

  @Comment(
      "This module will execute the specified commands if someone has OP but is not listed here.\n"
  ...
  public static class AllowedCommands {
    ...
    @Comment(
        "If you enable this, people with the 'commandcontrol.bypass.allowed-commands' permission\n"
    ...
    @Comment(
        "Message sent to the player when he tries to execute other command that is not allowed.")
  ...
  public static class BlockedCommands {
    ...
    @Comment(
        "If you enable this, people with the 'commandcontrol.bypass.blocked-commands' permission\n"
  ...
  public static class NamespacedCommands {
    ...
    @Comment(
        "If you enable this, people with the 'commandcontrol.bypass.namespaced-commands' permission\n"
  ...
  public static class CustomTabComplete {
    ...
    @Comment(
        "If you enable this, people with the 'commandcontrol.bypass.custom-tab-complete' permission\n"
  ...
  public static class OperatorProtection {
    ...
    @Comment(
        "How often (in seconds) should we check online players if they have operator?\n"
            + ""
    ...
    private final List<String> punishCommands =
        Arrays.asList("deop %player%", "ban %player% You are not allowed to have OP!");
